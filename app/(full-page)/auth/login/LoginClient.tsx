          ...
          <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-column gap-4" noValidate>
              <div className="flex flex-column gap-2">
                <label htmlFor="email1" className="text-900 text-xl font-medium">Correo Electrónico</label>
                <InputText
                  id="email1"
                  type="email"
              ...
              <div className="flex flex-column gap-2">
                <label htmlFor="password1" className="text-900 font-medium text-xl">Contraseña</label>
                <Password
                  inputId="password1"
                  value={password}
