  ...
  if (motivo === 'despido') {
    ...
    if (tipo === 'disciplinario') {
      ...
      const DISC_MAP = {
        'incumplimiento grave': [
          ...
          'Incumplimiento Grave',
          'El empleador debe acreditar la veracidad de los hechos imputados en las comunicaciones a que se refieren los incisos primero y cuarto del Artículo 162, sin que pueda alegar en el juicio hechos distintos como justificativos del despido',
          'Con fecha _________________________, el empleador me comunicó verbalmente que estaba despedido y que la comunicación del despido me sería hecha llegar el mismo día, situación que a la fecha de esta presentación aún no he recepcionado en mi domicilio.',
          'Conforme mandata el Artículo 454, número uno inciso segundo, “..., en los juicios sobre despido corresponderá en primer lugar al demandado la rendición de la prueba, debiendo acreditar la veracidad de los hechos imputados en las comunicaciones a que se refieren los incisos primero y cuarto del artículo 162, sin que pueda alegar en el juicio hechos distintos como justificativos del despido”.',
          'Entonces, no habiéndose cumplido con el Artículo 162 del Código del Trabajo, no tiene la contraria elementos de hecho que acreditar en estrados, ni puede agregar nuevos.',
          ...
          'En consecuencia, procede otorgar la indemnización sustitutiva del aviso previo, que asciende en concreto a la suma de ____________________',
          'También, por tanto, procede otorgar indemnización por años de servicio, correspondiente a: __________________ y es procedente que esta sea incrementada en un 80% siendo esta suma según apreciación de S.S. a si el despido es declarado con aplicación indebida de las causales del Artículo 160 del CT.'
        ],
        ...
        'otros especificar': [
          ...
          'Entonces, no habiéndose cumplido con el Artículo 162 del Código del Trabajo, no tiene la contraria elementos de hecho que acreditar en estrados, ni puede agregar nuevos.',
          (otro && otro.trim())
            ? `En el caso presente, la sub-causal invocada es: ${otro.trim()}.`
            : 'En el caso presente, la sub-causal invocada es: __________________.',
          'En el caso presente niego todas las imputaciones realizadas por el empleador, pues son falsas.',
          'En consecuencia, procede otorgar la indemnización sustitutiva del aviso previo, que asciende en concreto a la suma de ____________________',
          'También, por tanto, procede otorgar indemnización por años de servicio, correspondiente a: __________________ y es procedente que esta sea incrementada en un 80% siendo esta suma según apreciación de S.S. a si el despido es declarado con aplicación indebida de las causales del Artículo 160 del CT.'
        ],
      ...
      clauses.push(...pack);
      return { faltantes: [], clausulas: cleanup(clauses), flags };
    }
    ...
    if (tipo === 'necesidades de la empresa') {
      ...
      clauses.push(
        ...
        '• Recargo legal conforme a la causal legal invocada (30%):'
      );
      return { faltantes: [], clausulas: cleanup(clauses), flags };
    }
    ...
    if (tipo === 'sin causa' || tipo === 'sincausa') {
      ...
      clauses.push(
        ...
        'En consecuencia, procede otorgar la indemnización sustitutiva del aviso previo, que asciende en concreto a la suma de ____________________',
        'También, por tanto, procede otorgar indemnización por años de servicio, correspondiente a: __________________ y es procedente que esta sea incrementada en un 50% siendo esta suma según apreciación de S.S. a si el despido es declarado con aplicación indebida de las causales del Artículo 160 del CT.'
      );
