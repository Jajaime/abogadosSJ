            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="Nombres" header="Nombres" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="name" header="Apellidos" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="price" header="Rut" sortable body={priceBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="category" header="Materias" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
