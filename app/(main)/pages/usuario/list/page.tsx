...
const Usuarios = () => {
    ...
    const formatFecha = (rowData: any) => {
        const fecha = new Date(rowData.createdAt);
    ...
    const openNew = () => {
        router.push('/pages/usuario'); // Navega a la ruta específica
    };
        ...
        return (
            <React.Fragment>
                <div className="my-2">
                    ...
                    <Button label="Eliminar Usuario" icon="pi pi-trash" severity="danger" onClick={confirmDeleteSelected} disabled={!selectedProducts || !(selectedProducts as any).length} />
                </div>
            </React.Fragment>
        );
    };
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ref={dt}
                        value={usuarios} // Lista de usuarios obtenida de fetchUsuarios
                        selection={selectUsuarios}
                        selectionMode="single"
                        onSelectionChange={(e) => setSelectUsuarios(e.value as any)}
                        dataKey="id"
                        paginator
                        rows={10}
                        ...
                        currentPageReportTemplate="Mostrando {first} del {last} de {totalRecords} usuarios"
                    ...
                    >
                        ...
                        {/* Nombre del Usuario */}
                        <Column field="name" header="Nombre" sortable headerStyle={{ minWidth: '15rem' }}></Column>
