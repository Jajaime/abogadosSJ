            ...
            {loading ? (
                ...
                <form onSubmit={handleSubmit} className="p-fluid formgrid grid">
                    ...
                    <div className="field col-12">
                        ...
                        <InputText id="name" name="name" value={formData.name ?? ''} onChange={handleChange} placeholder="Ingrese el nombre del usuario" disabled={submitting} />
                    </div>

                    <div className="field col-12">
                        <label htmlFor="email">Correo Electrónico</label>
                        <InputText id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="Ingrese correo electrónico" required disabled={submitting} />
                    </div>

                    <div className="field col-12 text-center">
                        <div className="flex gap-2 justify-content-center">
                            <Button type="button" label="Cancelar" className="p-button-secondary" onClick={() => router.push('/pages/usuario')} disabled={submitting} />
                            <Button type="submit" label={isEdit ? 'Actualizar' : 'Registrar'} className="p-button-success" loading={submitting} />
                        </div>
                    </div>
                </form>
            )}
